...
<div class="container-fluid mt-n10">
	<div class="row">
		<div class="col-lg-6">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title panel-title">{{ _lang('Add Income') }}</h4>
				    <form method="post" class="validate" autocomplete="off" action="{{ route('income.store') }}" enctype="multipart/form-data">
						{{ csrf_field() }}
						<div class="row">
						    <div class="col-md-12">
