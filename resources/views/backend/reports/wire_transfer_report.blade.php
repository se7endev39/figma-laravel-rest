	...
	<div class="container-fluid">
		<div class="sb-page-header-content py-5">
			<h1 class="sb-page-header-title">
				...
				<span>{{ _lang('Wire Transfer Report') }}</span>
			</h1>
		</div>
	</div>
</div>
	...
	<div class="row">
		<div class="col-12">
			<div class="card panel-default">
				...
				<span class="d-none panel-title">{{ _lang('Wire Transfer Report') }}</span>

				<div class="card-body">

					<div class="report-params">
						<form class="validate" method="post" action="{{ url('admin/reports/wire_transfer_report/view') }}">
							<div class="row">
								{{ csrf_field() }}
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<select class="form-control select2" name="account" required>
											@foreach(\App\Account::all() as $user_account )
					...
					<div class="report-header mt-2">
						<h5>{{ isset($account) ? _lang('Wire Transfer Report of').' '.$acc->account_number.' - '.$acc->account_type->account_type : _lang('Wire Transfer Report') }}</h5>
