	...
	<div class="container-fluid">
		<div class="sb-page-header-content py-5">
			<h1 class="sb-page-header-title">
				...
				<span>{{ _lang('All Transaction') }}</span>
			</h1>
		</div>
	</div>
</div>
	...
	<div class="row">
		<div class="col-12">
			<div class="card panel-default">
				...
				<span class="d-none panel-title">{{ _lang('All Transaction') }}</span>

				<div class="card-body">

					<div class="report-params">
						<form class="validate" method="post" action="{{ url('user/reports/all_transaction/view') }}">
							<div class="row">
								{{ csrf_field() }}
