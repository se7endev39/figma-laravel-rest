	...
	<div class="container-fluid">
		<div class="sb-page-header-content py-5">
			<h1 class="sb-page-header-title">
				...
				<span>{{ _lang('Transfer Between Accounts') }}</span>
			</h1>
		</div>
	</div>
</div>
...
<div class="container-fluid mt-n10">
	<div class="row">
		<div class="col-12">
			...
			<div class="card">
				<div class="card-body">
					<h4 class="card-title panel-title">{{ _lang('Transfer Between Accounts') }}</h4>
					<form method="post" class="validate" autocomplete="off" action="{{ url('user/transfer_between_accounts') }}">
						{{ csrf_field() }}
						<div class="row">
							<div class="col-md-6">
								<div class="col-md-12">
